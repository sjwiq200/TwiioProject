    ...
    <jsp:include page="../common/pageNavigator_new.jsp"/>
		...
		<div class="modal-content">
  		...
  		<span class="input">
    		...
    		<input type="radio" name="star-input" id="p2" value="1.5"><label for="p2">1.5</label>
    		<input type="radio" name="star-input" id="p3" value="2"><label for="p3">2</label>
    		<input type="radio" name="star-input" id="p4" value="2.5"><label for="p4">2.5</label>
    		<input type="radio" name="star-input" id="p5" value="3"><label for="p5">3</label>
    		<input type="radio" name="star-input" id="p6" value="3.5"><label for="p6">3.5</label>
