    ...
    <jsp:include page="../common/pageNavigator_new.jsp"/>
		...
		<div class="modal-content">
			...
			<hr>	
				...
				<!-- <span class="star-input">
  				<span class="input2">
    			<input type="radio" name="star-input2" id="p1" value="1"><label for="p1">1</label>
    			<input type="radio" name="star-input2" id="p2" value="1.5"><label for="p2">1.5</label>
    			<input type="radio" name="star-input2" id="p3" value="2"><label for="p3">2</label>
    			<input type="radio" name="star-input2" id="p4" value="2.5"><label for="p4">2.5</label>
    			<input type="radio" name="star-input2" id="p5" value="3"><label for="p5">3</label>
    			<input type="radio" name="star-input2" id="p6" value="3.5"><label for="p6">3.5</label>
   				<input type="radio" name="star-input2" id="p7" value="4"><label for="p7">4</label>
    			<input type="radio" name="star-input2" id="p8" value="4.5"><label for="p8">4.5</label>
   				<input type="radio" name="star-input2" id="p9" value="5"><label for="p9">5</label>
  				</span>
				</span> -->
			</br>
				상품 리뷰
